<%@ taglib prefix="s" uri="/struts-tags" %>
		...
		<h1 class="page-header">Edit SRI</h1>
						...
						<form class="form-horizontal" role="form">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      ...
							      <select class="form-control" name="combobox" id="combobox" onchange="EventChanged(this)" >
						      		<option disabled="" value=""></option>
						      		<option selected="">Trucking</option>
		...
		<div class="btn-group" style="float: right;">
			...
			<button class="btn btn-default" onclick="location.href='vendor-list.jsp'">Cancel</button>
		</div>
		...
		<div class="btn-group" style="float: left;" id="trucking-option">
			<button class="btn btn-default" onclick="location.href='vendor-trucks.jsp'">Trucks</button>
