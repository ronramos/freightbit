				...
				<div class="panel panel-info">
					...
					<div class="panel-footer">
						...
						<div class="btn-group" style="float: right;">
							...
							<button class="btn btn-default" onclick="location.href='vendor-list.jsp'">Save</button>
						</div>
					</div>
                </s:form>
				</div>
			...
			<div class="sidebar-box">
			  <div class="panel booking panel-info">
				  ...
				  <div class="panel-body">
						...
						<ul class="nav">		  
						<li><a href="vendor-addvendor.jsp" class="side-help"><img src="includes/images/1.png" class="img-sidehelp">Personal Information</a></li>
