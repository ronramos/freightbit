            ...
            <div class="panel booking panel-info">
                ...
                <div class="panel-body">
                                  ...
                                  <div class="panel-heading">
                                    <h3 class="panel-title">Service Details</h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <s:select list="serviceReqt" name="servReqt" id="servReqt" cssClass="form-control" onchange="EventChanged1(this)" />
                                                </div>
                                            </div>
                                            <div id="service-mode" class="form-group">
                                                <label for="servMode" class="col-sm-5 control-label tb-font-black">Service Mode :</label>
                                                <div class="col-sm-6">
                                                    <s:select list="serviceMode" name="servMode" id="servMode" cssClass="form-control" onchange="EventChanged2(this)" />
                                                </div>
                                            </div>
                                  ...
                                  <div class="panel-heading">
                                    <h3 class="panel-title">Consignee Details</h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <s:textfield name="contactPerson" cssClass="form-control" id="contactPerson" placeholder="Contact Person"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="row">
							...
							<div class="col-md-12" id="cargo_details">
								<div class="panel panel-info">
								  <div class="panel-heading">
									<h3 class="panel-title">Cargo Details</h3>
										...
										<div class="form-group">
											...
											<button type="button" class="btn btn-primary" style="position: relative; left:82px" >Add Cargo</button>
											</div>
										</div>
								</div>
							</div>
								...
								<div class="panel panel-info">
								  <div class="panel-heading">
									<h3 class="panel-title">Item Details</h3>
										...
										<div class="form-group">
											<label for="containQty" class="col-sm-4 control-label tb-font-black">Item Quantity :</label>
											<div class="col-sm-6">
												<s:select list="containerQty" name="containQty" id="containQty" cssClass="form-control" onchange="EventChanged(this)" />
											</div>
										</div>
										<div class="form-group">
											<label for="containSize" class="col-sm-4 control-label tb-font-black">Item Size :</label>
											<div class="col-sm-6">
												<s:select list="containerSize" name="containSize" id="containSize" cssClass="form-control" onchange="EventChanged(this)" />
											</div>
										</div>
										<div class="form-group">
											<label for="cargoClass" class="col-sm-4 control-label tb-font-black">Item Classification :</label>
											<div class="col-sm-6">
											  <s:textfield name="cargoClass" cssClass="form-control" id="cargoClass" placeholder="Cargo Classification"/>
											</div>
										</div>
					...
					<div class="row">
						<div class="col-md-12" id="item_listing">
							<div class="panel panel-info">
							  <div class="panel-heading">
								<h3 class="panel-title">Item Listing</h3>
							  </div>
									<br />
										<div class="table-responsive">
										<table class="table table-striped text-center">
                ...
                <div class="panel-footer">
                    ...
                    <span class="pull-right">
                        <button type="button" class="btn new-booking" data-toggle="modal" data-target="#booking-search" onclick="location.href='Booking-Search'">
                              ...
                              <s:submit name="submit" value="Save" class="booking_save" />
