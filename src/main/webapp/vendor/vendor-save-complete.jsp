				  ...
				  <div class="panel panel-info">
							  ...
							  <tbody>
								<tr>
								  ...
								  <td class="tb-font-black">
									<a href="vendor-list-edit.jsp" class="icon-action-link" rel="tooltip" title="Edit this vendor"><img src="includes/images/edit-user.png" class="icon-action circ-icon"> </a>
					  ...
					  <div class="panel-footer">
							<span class="pull-right">
								<a href="vendor-addvendor.jsp" class="icon-action-link" rel="tooltip" title="Add Vendor"><img src="includes/images/add-user.png" class="icon-action circ-icon"> </a>
							</span>
